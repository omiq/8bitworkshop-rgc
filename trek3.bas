...
60 REM ** V3.0F2
70 REM ** COMMODORE 64 / PET / PLUS4
80 CLR:Z2$="":ATAKFLAG=0:SLSFLAG=0
85 CPU$="C64":REM "C64"/"PET"/"PLUS4"
86 COLOUR$="NO":REM "YES" / "NO" (NO = VANILLA)
90 REM ** COLOURS AT END OF LISTING **
95 IF CPU$="PET" THEN COLOUR$="NO"
96 GOSUB 6500
100 FOR N=1 TO 16:PRINT:NEXT
104 PRINT CCOL$;"COMPUTER TYPE: ";ECOL$;CPU$
105 IF CPU$="PET" THEN PRINT:GOTO 109
106 PRINT CCOL$;"COLOUR MODE  : ";
107 IF COLOUR$="NO" THEN PRINT ECOL$;"VANILLA"
108 IF COLOUR$="YES" THEN PRINT ECOL$;"FULL"
109 FOR N=1 TO 4:PRINT:NEXT
...
945 IF D(8)<0 AND A$="GAL" THEN PRINT:PRINT"SHIP'S COMPUTER DISABLED":GOTO 890
950 FORI=1TO9:IFLEFT$(A$,3)<>MID$(A1$,3*I-2,3)THEN GOTO 970
...
4140 IFD(8)<0THEN PRINT:PRINT"SHIP'S COMPUTER DISABLED":GOTO800
...
6595 REM CHR$(143)=NULL
6600 IF COLOUR$="YES" THEN GOTO 6650
6605 ACOL$=CHR$(143)
6610 BCOL$=CHR$(143)
6615 CCOL$=CHR$(143)
6620 DCOL$=CHR$(143)
...
6660 IF CPU$="PET" THEN RETURN
6670 IF CPU$="C64" THEN GOTO 6690
6680 IF CPU$="PLUS4" THEN GOTO 6700
6685 RETURN
6690 IF COLOUR$="YES" THEN POKE 53280,0:POKE 53281,0:POKE 646,5:RETURN
6695 RETURN
6700 IF COLOUR$="YES" THEN COLOR 4,1,0:COLOR 0,1,0:COLOR 1,6,3:RETURN
6710 RETURN