   ...
   20 PRINT CHR$(147)
   30 PRINT "{HOME}             {RVS}SPACE LANDER{RVS OFF}"
   40 PRINT "{13}      SPACE=THRUST O=LEFT P=RIGHT"
   50 PRINT "{13}{13}           CHOOSE DIFFICULTY:"
   60 PRINT "{13}               {rvs}1{rvs off} EASY"
   70 PRINT "{13}               {rvs}2{rvs off} MEDIUM"
   80 PRINT "{13}               {rvs}3{rvs off} HARD"
